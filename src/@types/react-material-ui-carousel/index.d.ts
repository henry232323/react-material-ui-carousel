...
export interface CarouselProps {
    ...
    NavButton?: (props: { onClick: Function, sx: SxProps<Theme>, style: React.CSSProperties, next: boolean, prev: boolean }) => ReactNode

    /** Used to customize the indicators container/wrapper.  
     * Type: `{sx: SxProps<Theme>, style: React.CSSProperties}` */
